<template>
  <div class="bills">
    ...
    <BillTableList v-if="!loading && bills">
      <!-- exemple pour personnaliser les th du tableau BillTableList : -->
      <!-- <template #thead>
        <th>test</th>
        <th>test</th>
        <th>test</th>
...
import BillTableList from '@/components/tables/BillTableList.vue'
